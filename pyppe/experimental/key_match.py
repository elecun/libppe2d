...
img1 = cv2.imread('./pyppe/experimental/capture1.png') # 찾고 싶은거
img2 = cv2.imread('./pyppe/experimental/capture2.png') # 대상
...
gray1 = cv2.Canny(gray1, 50,100)
gray2 = cv2.Canny(gray2, 50,100)
