...
bool camera_initFromFile(std::string filename, ArduCamHandle &cameraHandle, ArduCamCfg &cameraCfg) {
	...
	cout << "ic2 mode :" << std::hex << cam_param->i2c_mode << endl;
	...
	cout << "image size : " << cameraCfg.u32Width << "," << cameraCfg.u32Height << endl;
	...
	cout << "I2C Address : " << cameraCfg.u32I2cAddr << endl;
	cout << "Pixel bits : " << cameraCfg.u8PixelBits << endl;
	cout << "Trans Level : " << cameraCfg.u32TransLvl << endl;
